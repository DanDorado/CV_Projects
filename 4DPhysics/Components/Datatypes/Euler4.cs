...
namespace Engine4
{
    ...
    public struct Euler4 : IEquatable<Euler4>
    {
        ...
        /// Axis-wisely scale an euler values with a number
        /// </summary>
        static public Euler4 operator *(float f, Euler4 lhs)
        {
            return lhs * f;
        }
        ...
        /// </summary>
        /// <remarks> This method is equivalent to the wedge operation between vector and vector in Geometry Algebra. It is used by internal physics engine. </remarks>
        ...
        /// </summary>
        /// <remarks> This method is equivalent to the wedge operation between bivector and vector in Geometry Algebra. It is used by internal physics engine. </remarks>

...
namespace Engine4
{
    ...
    public struct Vector4 : IEquatable<Vector4>
    {
        ...
        /// Axis-wisely scale an euler values with a number
        /// </summary>
        static public Vector4 operator *(float f, Vector4 lhs)
        {
            return new Vector4(lhs.x * f, lhs.y * f, lhs.z * f, lhs.w * f);
        }
        /// <summary>
        ...
        /// <remarks>
        /// <para>
        /// This cross operation finds the other vector that perpendicular to the three vector.
        ...
        /// </summary>
        /// <remarks> This method is much faster, and should be used if it means only for comparison </remarks>
        ...
        /// </summary>
        /// <seealso cref="Utility.Invert(float)"/>
